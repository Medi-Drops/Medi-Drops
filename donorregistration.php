...
if(count($_POST)>0) {
	...
	$sql = "INSERT INTO `registration form` (`FullName`, `BloodGroup`, `Gender`, `DateofBirth`, `ContactNumber`, `slct1`, `slct2`, `EmailId`, `text`, `UserId`, `Password`, `Re-Password`) VALUES ('" . $_POST["FullName"] . "', '" . $_POST["BloodGroup"] . "', '" . $_POST["Gender"] . "', '" . $_POST["DateofBirth"] . "', '" . $_POST["ContactNumber"] . "', '" . $_POST["slct1"] . "', '" . $_POST["slct2"] . "', '" . $_POST["EmailId"] . "', '" . $_POST["text"] . "', '" . $_POST["UserId"] . "','" . $_POST["Password"] . "','" . $_POST["Re-Password"] . "')";
...
?>-->
   ...
   <?php
		...
		//$message = "Registration Successfull";
		header("Location:donorlogin.php?login=success");
	 }	 
...
<nav1>
	<ul>
	<li><a class="active" href="donorregistration.php">Registration</a></li>
...
<p>Date of Birth : <input type="date" id="DateofBirth" name="DateofBirth" maxlength="10"></p>

<p>Contact Number : +91<input type="text" id="ContactNumber" name="ContactNumber" maxlength="20"></p>
...
<p><label for="text">Address:</label>
<textarea name="text" cols="50" rows="5" maxlength="1000">
</textarea>
</p>
...
<p>Re-Password : <input type="password" id="Re-Password" name="Re-Password" ></p>

<!--<input type="checkbox" value="I authorise the website to display my name and telephone number, so that the needy could contact me, as and when there is an emergency.">I authorise the website to display my name and telephone number, so that the needy could contact me, as and when there is an emergency.
-->
<aside><input type="submit" value="Submit" name="submit"></aside>

<small>
<b>Important :</b> <i>All Voluntary Donors are warned of likely misuse of blood donated by them at the hospital with or without the knowledge of the hospital management. At some places the hospital staff have taken the blood and sold it to others for a price. As a responsible citizen/voluntary blood donor, we request you to keep a watch on such people and hospitals.</i>
</small>
