...
<nav1>
	...
	<li><a class="active" href="blooddonationfacts1.php">Blood Donation Facts</a></li>
...
<h2>Facts about the blood supply:</h2>
...
<h2>Facts about the blood donation process:</h2>
...
<h2>Facts about blood and its components:</h2>

<div id="example4">
<p>
	<li>Blood makes up about 7 percent of your body's weight.</li>
	<li>There are four types of transfusable products that can be derived from blood: red cells, platelets, plasma and cryoprecipitate. Typically, two or three of these are produced from a unit of donated whole blood – hence each donation can help save up to three lives.</li>
...
<br>There are four main blood types: A, B, AB and O.<br>
<br>In 1901, Karl Landsteiner, an Austrian physician, discovers the first three human blood groups. On his birthday i.e June 14th "World Blood Donors Day" celebrates. On October 1st ‘National Blood Donation Day’ celebrates in India.
</p>
</div>
