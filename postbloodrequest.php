...
if(count($_POST)>0) {
	...
	$sql = "INSERT INTO `post blood request` (`PatientFullName`, `BloodGroup`, `PatientAge`, `Whenyouneedblood`, `Howmanyunitsyouneed`, `ContactNumber`, `HospitalName`, `slct1`, `slct2`, `text`, `text2`) VALUES ('" . $_POST["PatientFullName"] . "', '" . $_POST["BloodGroup"] . "', '" . $_POST["PatientAge"] . "', '" . $_POST["Whenyouneedblood"] . "', '" . $_POST["Howmanyunitsyouneed"] . "', '" . $_POST["ContactNumber"] . "', '" . $_POST["HospitalName"] . "', '" . $_POST["slct1"] . "', '" . $_POST["slct2"] . "', '" . $_POST["text"] . "','" . $_POST["text2"] . "')";
...
<nav1>
	...
	<li><a class="active" href="postbloodrequest.php">Post Blood Request</a></li>
...
<p>Patient Full Name : <input type="text" id="PatientFullName" name="PatientFullName" maxlength="20"></p>

<p>Patient Blood Group :
...
<p>Patient Age : <input type="text" id="PatientAge" name="PatientAge" maxlength="20"></p>

<p>When you need blood ? : <input type="date" id="Whenyouneedblood" name="Whenyouneedblood"></p>

<p>How many units you need ? : <input type="text" id="Howmanyunitsyouneed" name="Howmanyunitsyouneed"></p>

<p>Contact Number : +91<input type="text" id="ContactNumber" name="ContactNumber" maxlength="10"></p>

<p>Hospital Name : <input type="text" id="HospitalName" name="HospitalName" ></p>
...
<p><label for="text">Patient Address:</label>
<textarea name="text" >
</textarea>
</p>

<p><label for="text2">Purpose:</label>
<textarea name="text2" >
</textarea>
</p>

<aside><input type="submit" value="Submit" method='post' action='' ></aside>
</fieldset>
</form>
